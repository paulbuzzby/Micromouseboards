// Generated by SolidPython 1.1.3 on 2025-08-26 11:37:11
$fa = 0.4; $fs = 0.4;
...
rotate(a = 180, v = [1, 0, 0]) {
	difference() {
		...
		linear_extrude(center = true, height = 0.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "E:/sourcecode/Micromouseboards/SSEverythingMainBoard/SSEverythingMainBoard-PasteTop.dxf", origin = [0, 0]);
			}
		}
	}
}
