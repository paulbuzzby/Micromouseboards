// Generated by SolidPython 1.1.3 on 2025-04-28 21:37:47
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 0.9000000000) {
					offset(r = 1.0000000000) {
						import(file = "E:/sourcecode/Micromouseboards/SSWallSensorBoard/SSWallSensorBoard-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "E:/sourcecode/Micromouseboards/SSWallSensorBoard/SSWallSensorBoard-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
